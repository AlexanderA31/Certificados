    ...
    class Conectar{
        ...
        protected function Conexion(){
            try {
				...
				$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=andercode_diplomas_v6","root","");
                /*TODO: Cadena de Conexion Produccion*/
				//$conectar = $this->dbh = new PDO("mysql:local=localhost;dbname=progracademy","diploma1","root");
				return $conectar;
			} catch (Exception $e) {
        ...
        public static function ruta(){
            //QA
            return "http://localhost:90/ProyectoProgracademy/";
